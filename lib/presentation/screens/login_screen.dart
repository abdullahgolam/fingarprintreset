...
import 'package:fingarprintreset/constnats/my_colors.dart';
...
class LoginScreen extends StatelessWidget {
      ...
      children: [
        Expanded(
          ...
          child: Container(
            ...
            child: Text(
              generatCountryFlag() + ' +966',
              style: TextStyle(fontSize: 14, letterSpacing: 2.0),
            ),
          ),
        ),
        SizedBox(
  ...
  Widget _buildPhoneNumberSubmitedBlock() {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPhoneNumberSubmitedBlock(),
              ],
            ),
          ),
        ),
